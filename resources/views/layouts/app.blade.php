...
<body>
    <div class="d-flex justify-content-center align-items-center vh-100" id="app">
        <main class="welcome d-flex align-items-center justify-content-evenly">
            <!-- Authentication Links -->
            @guest
            <div class="welcome-pills">
                <a class="marker-font nav-link" href="{{ route('login') }}" style="color: #CF627F;">{{ __('Login') }}</a>
            </div>
            @if (Route::has('register'))
            <div class="welcome-pills">
                <a class="marker-font nav-link" href="#" style="color: #1B7676;" data-bs-toggle="modal" data-bs-target="#registerModal">{{ __('Register') }}</a>
            </div>
